...
const Episode = ({episode, feed}) => {
    return <div className='Episode'>
        ...
        <div className='description'>{episode.content}</div>
        <div className='duration'>{episode.itunes.duration}</div>
        <EpisodeMedia episode={episode}/>
        <img className='image' src={episode.itunes.image || feed.itunes.image} width={300} height={300} alt='Episode illustration'/>
